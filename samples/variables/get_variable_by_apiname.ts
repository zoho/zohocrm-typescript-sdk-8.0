...
class GetVariableByApiname {
    static async getVariableByApiname(): Promise<void> {
        ...
        // parameterMap.add(ZOHOCRMSDK.Variables.GetVariableByAPINameParam.GROUP, "General");
        
        const response = await variablesOperations.getVariableByApiname(apiName, parameterMap);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetVariableByApiname.getVariableByApiname();
    }
}

GetVariableByApiname.initializeAndCall();