...
class UpdateContactRole {
    static async updateContactRole(roleId: bigint): Promise<void> {
        ...
        const contactRole = new ZOHOCRMSDK.ContactRoles.ContactRole();
        contactRole.setName("Updated Single Contact Role");
        contactRole.setSequenceNumber(5);
        contactRoles.push(contactRole);
        
        bodyWrapper.setContactRoles(contactRoles);
        
        const response = await contactRolesOperations.updateContactRole(roleId, bodyWrapper);
    ...
    public static async initializeAndCall() {
        ...
        await UpdateContactRole.updateContactRole(roleId);
    }
}
