...
class GetRelatedRecord {
    static async getRelatedRecord(): Promise<void> {
        ...
        const response = await relatedRecordsOperations.getRelatedRecord(relatedRecordId, recordId, paramInstance, headerInstance);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetRelatedRecord.getRelatedRecord();
    }
}
