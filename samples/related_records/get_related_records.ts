...
class GetRelatedRecords {
    static async getRelatedRecords(): Promise<void> {
        ...
        const fieldNames = ["Last_Name", "Email", "Phone"];
        await paramInstance.add(ZOHOCRMSDK.RelatedRecords.GetRelatedRecordsParam.FIELDS, fieldNames.toString());
        // await paramInstance.add(ZOHOCRMSDK.RelatedRecords.GetRelatedRecordsParam.IDS, "1055806000005356009");
        
        await headerInstance.add(ZOHOCRMSDK.RelatedRecords.GetRelatedRecordsHeader.IF_MODIFIED_SINCE, new Date("2020-06-01T00:00:00+00:00"));
        
        const response = await relatedRecordsOperations.getRelatedRecords(recordId, paramInstance, headerInstance);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetRelatedRecords.getRelatedRecords();
    }
}
