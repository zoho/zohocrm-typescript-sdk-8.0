...
class UpdateModuleByAPIName {
    static async updateModuleByAPIName(): Promise<void> {
        const apiName = "CustomModule1";
        ...
        module.setModuleName("Updated Custom Module 1");
        module.setSingularLabel("Updated Custom Record");
        module.setPluralLabel("Updated Custom Records");
        // Update profiles
        const profiles = [];
        ...
        const response = await modulesOperations.updateModuleByAPIName(apiName, request);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await UpdateModuleByAPIName.updateModuleByAPIName();
    }
}
