...
class GetRecords {
    static async getRecords(): Promise<void> {
        ...
        // Add parameters for pagination and filtering
        await paramInstance.add(ZOHOCRMSDK.Record.GetRecordsParam.FIELDS, "Last_Name,First_Name,Company,Email,Phone,Lead_Status");
        ...
        // await paramInstance.add(ZOHOCRMSDK.Record.GetRecordsParam.IDS, "1055806000023311047");
