...
class GetRelatedLists {
    static async getRelatedLists(): Promise<void> {
        ...
        await paramInstance.add(ZOHOCRMSDK.RelatedLists.GetRelatedListsParam.MODULE, "Leads");
        
        const response = await relatedListsOperations.getRelatedLists(paramInstance);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetRelatedLists.getRelatedLists();
    }
}
