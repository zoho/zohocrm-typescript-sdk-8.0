...
class ChangeSortOrderOfCustomViews {
    static async changeSortOrderOfCustomViews(): Promise<void> {
		...
		customView.setId(BigInt("1055806000020849005"));
        ...
        await paramInstance.add(ZOHOCRMSDK.CustomViews.ChangeSortOrderOfCustomViewsParam.MODULE, "Leads");
        
        const response = await customViewsOperations.changeSortOrderOfCustomViews(request, paramInstance);
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await ChangeSortOrderOfCustomViews.changeSortOrderOfCustomViews();
    }
}

ChangeSortOrderOfCustomViews.initializeAndCall();