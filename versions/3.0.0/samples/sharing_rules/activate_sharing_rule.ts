...
class ActivateSharingRule{
    static async activateSharingRule(id : bigint, moduleAPIName : string) {
        ...
        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.SharingRules.ActionHandler.MasterModel> = await sharingRulesOperations.activateSharingRule(id);
        if(response){
    ...
    static async initializeAndCall() {
        ...
        await ActivateSharingRule.activateSharingRule(recordId, moduleAPIName);
    }
}
ActivateSharingRule.initializeAndCall();