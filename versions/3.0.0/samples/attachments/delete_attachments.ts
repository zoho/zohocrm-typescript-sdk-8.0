...
class DeleteAttachments {
    static async deleteAttachments(recordId: bigint, moduleAPIName: string, attachmentIds: string[]): Promise<void> {
        ...
        const response = await attachmentsOperations.deleteAttachments(recordId, moduleAPIName, paramInstance);
    ...
    public static async initializeAndCall() {
        ...
        let attachmentIds = ["1055806000028644005"];
        await DeleteAttachments.deleteAttachments(recordId, moduleAPIName, attachmentIds);
    }
}
