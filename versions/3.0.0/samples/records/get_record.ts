...
class GetRecord {
    static async getRecord(): Promise<void> {
        ...
        const response = await recordOperations.getRecord(recordId, paramInstance, headerInstance);
        if (response != null) {
