...
class GetRecordUsingExternalId {
    static async getRecordUsingExternalId(): Promise<void> {
        ...
        const destinationFolder = "./"; // Destination folder path to store the downloaded file
        const paramInstance = new ZOHOCRMSDK.ParameterMap();
        const headerInstance = new ZOHOCRMSDK.HeaderMap();
        
        // Set external field header
        await headerInstance.add(ZOHOCRMSDK.Record.GetRecordUsingExternalIDHeader.X_EXTERNAL, "Leads.External_Lead_ID");
        
        const response = await recordOperations.getRecordUsingExternalId(externalFieldValue, paramInstance, headerInstance);
        if (response != null) {
    ...
    public static async initializeAndCall() {
        ...
        await(new ZOHOCRMSDK.InitializeBuilder())
            ...
            .token(token)
            .initialize();
        await GetRecordUsingExternalId.getRecordUsingExternalId();
    }
}
