...
class WebformsOperations{
	 ...
	 * @throws SDKException
	 */
	public async getWebForm(formId: string): Promise<APIResponse<ResponseHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v8/settings/webforms/");
	 ...
	 * @throws SDKException
	 */
	public async updateWebForm(formId: string, request: BodyWrapper): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v8/settings/webforms/");
		apiPath = apiPath.concat(formId.toString());
	 ...
	 * @throws SDKException
	 */
	public async deleteWebForms(formId: string): Promise<APIResponse<ActionHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v8/settings/webforms/");
		apiPath = apiPath.concat(formId.toString());
	 ...
	 * @throws SDKException
	 */
	public async getWebformsPreview(formId: string): Promise<APIResponse<ResponseHandler>>	{
		let handlerInstance: CommonAPIHandler = new CommonAPIHandler();
		let apiPath: string = '';
		apiPath = apiPath.concat("/crm/v8/settings/webforms/");
		apiPath = apiPath.concat(formId.toString());
