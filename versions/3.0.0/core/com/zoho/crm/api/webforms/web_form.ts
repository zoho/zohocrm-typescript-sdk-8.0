...
class WebForm implements Model{
	...
	private actionOnDuplicate: string;
	...
	private formSections: Array<FormSection>;
	private name: string;
	 ...
	 */
	public getAcknowledgeVisitor(): AcknowledgeVisitor	{
	 ...
	 */
	public setAcknowledgeVisitor(acknowledgeVisitor: AcknowledgeVisitor): void	{
	 ...
	 */
	public getActionOnDuplicate(): string	{
	 ...
	 */
	public setActionOnDuplicate(actionOnDuplicate: string): void	{
	 ...
	 */
	public getDoubleOptinDetails(): DoubleOptinDetails	{
	 ...
	 */
	public setDoubleOptinDetails(doubleOptinDetails: DoubleOptinDetails): void	{
	 ...
	 */
	public getFormSections(): Array<FormSection>	{
	 ...
	 */
	public setFormSections(formSections: Array<FormSection>): void	{
	 ...
	 */
	public getVisitorTracking(): VisitorTracking	{
	 ...
	 */
	public setVisitorTracking(visitorTracking: VisitorTracking): void	{
	 ...
	 */
	public setShowBrand(showBrand: boolean): void	{
	 ...
	 */
	public getSpamControl(): SpamControl	{
	 ...
	 */
	public setSpamControl(spamControl: SpamControl): void	{
	 ...
	 */
	public setSmartUrl(smartUrl: string): void	{
