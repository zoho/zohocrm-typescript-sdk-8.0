...
class GetRelatedRecordsParam{
	...
	public static IDS: Param<string> = new Param<string>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsParam");
}
...
class GetRelatedRecordsUsingExternalIDParam{
	...
	public static IDS: Param<string> = new Param<string>("ids", "com.zoho.crm.api.RelatedRecords.GetRelatedRecordsUsingExternalIDParam");
}
