export class Constants {
    ...
    public static SET_TO_CONTENT_TYPE = ["/crm/bulk/v8/read", "/crm/bulk/v8/write", "/crm/v8/settings/audit_log_export", "/crm/v8/__zia_org_enrichment", "/crm/v8/__zia_people_enrichment"];
