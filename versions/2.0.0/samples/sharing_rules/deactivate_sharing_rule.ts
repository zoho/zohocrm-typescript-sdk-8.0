...
class DeactivateSharingRule{
    ...
    static async deactivateSharingRule(id: bigint, moduleAPIName: string) {
        ...
        const response: ZOHOCRMSDK.APIResponse<ZOHOCRMSDK.SharingRules.ActionHandler.MasterModel> = await sharingRulesOperations.deactivateSharingRule(id);
        if (response) {
    ...
    static async initializeAndCall() {
        ...
        await DeactivateSharingRule.deactivateSharingRule(recordId, moduleAPIName);
    }
}
DeactivateSharingRule.initializeAndCall();